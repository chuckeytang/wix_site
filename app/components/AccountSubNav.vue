<template>
  ...
  // 定义导航项的数据结构
  const navItems = [
    { label: '您的会员计划', path: '/account/plan' },
    { label: '订单', path: '/account/orders' },
    { label: '联系信息', path: '/account/contact' },
    { label: '设置', path: '/account/settings' },
    { label: '活动历史记录', path: '/account/history' },
  ];
